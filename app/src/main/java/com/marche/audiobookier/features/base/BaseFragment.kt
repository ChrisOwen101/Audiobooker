package com.marche.audiobookier.features.base
...
import com.marche.audiobookier.injection.component.DaggerConfigPersistentComponent
import com.marche.audiobookier.injection.component.FragmentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .appComponent(AudiobookerApplication[activity as Context].component)
                    .build()
